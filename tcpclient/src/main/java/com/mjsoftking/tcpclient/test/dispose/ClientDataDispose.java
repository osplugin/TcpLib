...
//            }
            ...
            byte[] b = bufferQueue.copyAndRemove(bufferSize);

            EventBus.getDefault().post(new TcpClientReceiveDataEvent(servicePort, clientAddress, CommonDataUtils.bytesToHexString(b)));
        } catch (Exception e) {
